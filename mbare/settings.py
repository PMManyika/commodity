"""
Django settings for mbare project.
...
SECRET_KEY = "django-insecure-y0*grn$mcp(4d=3e8*+@-0_zz4hg87b_jw2smex0l36=#2^$ks"
...
WSGI_APPLICATION = "mbare.wsgi.application"
